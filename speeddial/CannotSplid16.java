...
/**
 * 21.竖屏时，不超过一屏时,当speed dial在手机屏幕上可以全部显示，左右或上下滑动屏幕,屏幕不能左右滑动和上下滑动
 * @author xzhou
 * 
 */
@ClassOrder({ PackageOrder.screenspeeddial, 16 })
@MediumTest
@TestClass("竖屏时，不超过一屏时,当speed dial在手机屏幕上可以全部显示，左右或上下滑动屏幕,屏幕不能左右滑动和上下滑动")
public class CannotSplid16 extends BaseTest {
